...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { date_created: @day.date_created, day_no: @day.day_no, note: @day.note, user_id: @day.user_id } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date_created: @day.date_created, day_no: @day.day_no, note: @day.note, user_id: @day.user_id } }
