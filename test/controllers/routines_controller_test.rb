...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { description: @routine.description, name: @routine.name } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { description: @routine.description, name: @routine.name } }
